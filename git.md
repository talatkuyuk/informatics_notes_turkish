...
$ git checkout a1b2c3 *you can use a commit hash*  
$ git checkout v2.0.0 *you can use a tag name*  
$ git checkout tags/v2.0.0 *you can use a tag name either with /tags prefix*  
