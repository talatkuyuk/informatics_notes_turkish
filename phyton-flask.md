...
app = Flask(**name**)
The passed special variable **name** holds the name of the current Python module. It’s used to tell the instance where it’s located. You need this because Flask sets up some paths behind the scenes.

@app.route('/')
It is a **decorator** that turns a regular Python function into a **Flask view function**, which converts the function’s return value into an _HTTP response_ to be displayed by an HTTP client, such as a web browser.
